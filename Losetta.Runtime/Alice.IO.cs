...
namespace AliceScript.NameSpaces
{
    ...
    internal static class FileFunctions
    {
        ...
        {
            FileEncrypter.FileEncrypt(path, outpath, password);
        }
        public static void File_Decrypt(string path, string outpath, string password)
        {
            FileEncrypter.FileDecrypt(path, outpath, path);
        }
    ...
    {
        internal static void FileDecrypt(string FilePath, string OutFilePath, string Password)
        {
            int len;
        ...
        internal static void FileEncrypt(string FilePath, string OutFilePath, string Password)
        {
